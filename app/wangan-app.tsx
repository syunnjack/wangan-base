...
const ownerGarage = [
  ...
  },
  {
    ...
    distance: "",
    updated: "2026年9月14日",
    note: "名古屋を走っている。ビンゴチャレンジで3列を達成した日もある。撃破トロフィーは207本。",
  },
  {
    slot: "03",
    maker: "SUBARU",
...
const playLog = [
  ...
  },
  {
    ...
    body: [
      "エボ3の撃破トロフィーが207本になった。9月11日が140本だったので、3日で67本増えたことになる。",
      "トロフィーの本数と累計撃破数は同じではないので、ランクがどこまで進んだかはトロフィーだけでは分からない。次に湾岸ナビゲーターで累計撃破数を見てみる。",
    ],
  },
  {
    updated: "2026年9月12日",
    headline: "C4級に上がり、ビンゴが3列そろった",
    body: [
      "エボ3がC4級に上がった。",
      "ビンゴチャレンジで3列そろえて、その日のぶんはクリアになった。3列そろえると翌日まで遊べなくなるので、同じカードの別の車でも続きはできない。",
      "スクラッチで引いた軽自動車の車種を確認した。R2だった。",
    ],
  },
  {
    updated: "2026年9月11日",
