...
const description = "湾岸ミッドナイト マキシマムチューン 6RR PLUS を遊んだ記録を、運営者ひとりが書いていく非公式サイト。同じカードに4台を登録しています。R32 GT-Rは称号「連装キング」でC5級720馬力、エボ3はC4級600馬力で名古屋のビンゴと全国分身、スクラッチで引いた軽自動車のR2、廃車カードで作ったR34 V-spec II。全国の公式設置店一覧へのリンクも置いています。";
